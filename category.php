...
<main id="primary" class="site-main">
    <div class="w-full bg-white category-page">
        ...
        <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            <div class="flex flex-col md:flex-row w-full max-w-4xl m-auto border-b border-[#6666664c] pb-12 mt-12 relative">
                <div class="w-full md:w-1/3 px-4 md:pl-8 md:pr-0 lg:pl-0">
                    <a href="<?php the_permalink(); ?>" class="block border border-[#BA9E5E5E]">
                        <?php if ( has_post_thumbnail() ) : ?>
                            <img class="p-2" src="<?php the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>">
                        <?php endif; ?>
                    </a>
                </div>
